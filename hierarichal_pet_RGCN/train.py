...
pet_weights = torch.load('./pet_epoch_59.pth')['model']

model.load_state_dict(new_params)
model.pet_unet.load_state_dict(pet_weights)

for name, param in model.pet_unet.named_parameters():
...
resume = 15
if resume:
    state_model = torch.load( '/home/fumcomp/Desktop/poorsoltani/hierarichal_pet_rgcn/epoch_'+ str(resume - 1) + '.pth')
...
for i in range(resume, EPOCHE):
    ...
    }, '/home/fumcomp/Desktop/poorsoltani/hierarichal_pet_rgcn/epoch_' + str(i) + '.pth')
    print('##########################################')
