...
if resume:
    state_model = torch.load(
        '/home/fumcomp/Desktop/poorsoltani/10_later_former_polygon_lr/epoch_' + str(resume - 1) + '.pth')
...
for i in range(resume, EPOCHE):
    ...
    }, '/home/fumcomp/Desktop/poorsoltani/10_later_former_polygon_lr/epoch_' + str(i) + '.pth')
    print('##########################################')
