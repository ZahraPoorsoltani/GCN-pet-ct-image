...
resume = 0
if resume:
    state_model = torch.load('/home/fumcomp/Desktop/poorsoltani/pet_rgcn_attention/epoch_' + str(resume - 1) + '.pth')
...
for i in range(resume, EPOCHE):
    ...
    }, '/home/fumcomp/Desktop/poorsoltani/pet_rgcn_attention/epoch_' + str(i) + '.pth')
    print('##########################################')
