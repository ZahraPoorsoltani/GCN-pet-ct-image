...
evaluate = open('./logs/evaluate_former_later.txt', 'a')
...
min_BCE = 100
THRESHOLD = 0.5
for e in range(22,30):
    cnt = 0
    BCE_log = []
    weights = torch.load('/home/fumcomp/Desktop/poorsoltani/avs_like_lr_later_former/epoch_' + str(e) + '.pth', map_location='cuda')['model']
