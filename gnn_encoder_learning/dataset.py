...
class LungDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if idx + 10 < search_idx[1] and idx - 10 >= search_idx[0]:
            search_idx1 = np.random.randint(idx - 10, idx + 10)
            while search_idx1 == idx:
                search_idx1 = np.random.randint(idx - 10, idx + 10)
            search_idx2 = np.random.randint(idx - 10, idx + 10)
            while search_idx2 == search_idx1 or search_idx2 == idx:
                search_idx2 = np.random.randint(idx - 10, idx + 10)

        elif idx + 10 >= search_idx[1] and idx - 10 >= search_idx[0]:
            loc = search_idx[1] - idx
            search_idx1 = np.random.randint(idx - (10 + (10 - loc)), idx + loc)
            while search_idx1 == idx:
                search_idx1 = np.random.randint(idx - (10 + (10 - loc)), idx + loc)

            search_idx2 = np.random.randint(idx - (10 + (10 - loc)), idx + loc)
            while search_idx2 == search_idx1 or search_idx2 == idx:
                search_idx2 = np.random.randint(idx - (10 + (10 - loc)), idx + loc)
            ...
            search_idx1 = np.random.randint(idx - loc, idx + (10 + (10 - loc)))
            while search_idx1 == idx:
                search_idx1 = np.random.randint(idx - loc, idx + (10 + (10 - loc)))

            search_idx2 = np.random.randint(idx - loc, idx + (10 + (10 - loc)))
            while search_idx2 == search_idx1 or search_idx2 == idx:
                search_idx2 = np.random.randint(idx - loc, idx + (10 + (10 - loc)))

        for i in [idx, search_idx1, search_idx2]:
