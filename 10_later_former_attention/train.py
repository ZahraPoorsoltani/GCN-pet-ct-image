...
resume = 22
if resume:
    state_model = torch.load('/home/fumcomp/Desktop/poorsoltani/10_later_former_attention/epoch_' + str(resume - 1) + '.pth')
...
for i in range(resume, EPOCHE):
    ...
    torch.save({
        ...
        }, '/home/fumcomp/Desktop/poorsoltani/10_later_former_attention/epoch_' + str(i) + '.pth')
    print('##########################################')
