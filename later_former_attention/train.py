...
logger = open('/home/fumcomp/Desktop/poorsoltani/later_former_attention/logs.txt', 'a')
resume = 7
if resume:
    state_model = torch.load('/home/fumcomp/Desktop/poorsoltani/later_former_attention/epoch_' + str(resume - 1) + '.pth')
...
for i in range(resume, EPOCHE):
    ...
    }, '/home/fumcomp/Desktop/poorsoltani/later_former_attention/epoch_' + str(i) + '.pth')
    print('##########################################')
